...
<div class="page">
       <div class="navbar">
           ...
           <h1>SSkyline<span style="font-family: 'Merienda', cursive;
            color:rgb(20, 76, 80);">Oasis</span></h1>
           <nav>
               <ul>
    ...
    <footer>
        <div class="main-content">
            <div class="left box">
                ...
                <div class="content">
                    <p>
                        SkylineOasis is webapp  where society members can get all the updates related to their society. The members also get notified with notices and events held in society and can see information about members in society. Members can also post complaints regarding any issue in society. 
                    </p>
                </div>
            </div>
            ...
            <div class="right box">
                ...
                <div class="content">
                    ...
                    <div class="email">
                        ...
                        <span class="text">SkylineOasis@gmail.com</span>
                    </div>
                </div>
            </div>
        </div>
